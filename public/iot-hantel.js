...
function updateVariables(data) {
    ...
    if (data.eventName === "command") {
        document.getElementById("traininfo").innerHTML = data.eventData;
    }
}
...
async function getTrainingscount() {
    // request the variable "Trainingscount"
    var response = await axios.get(rootUrl + "/api/device/0/variable/Trainingscount");
    var Trainingscount = response.data.result;

    // update the html element
    document.getElementById("Trainingscount").innerHTML = Trainingscount;
}
